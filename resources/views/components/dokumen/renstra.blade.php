...
@section('navbar')
    <div class="container p-4 mx-auto mt-24 mb-20">
        <h1 class="mb-4 text-3xl font-bold text-center text-gray-800">Dokumen Kategori Renstra-PD</h1>
        <p class="mb-8 text-center">Rencana Strategis Perangkat Daerah</p>
